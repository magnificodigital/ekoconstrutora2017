	...
	<form id="<?php echo $prefix; ?>form" name="<?php echo $prefix; ?>form" method="post" class="form">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			<label for="<?php echo $prefix; ?>cpf">
				<input type="text" name="<?php echo $prefix; ?>cpf" placeholder="CPF:" value="<?php the_field('cpf', 'user_'.$id); ?>" class="cpf" disabled>
			</label>
		</div>
		<div class="col-md-6 col-sm-6 col-xs-12">
			<label for="<?php echo $prefix; ?>creci">
				<input type="text" name="<?php echo $prefix; ?>creci" placeholder="CRECI:" value="<?php the_field('creci', 'user_'.$id); ?>" disabled>
			</label>
		</div>
